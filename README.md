...
**Executive Summary**
This analysis identifies a drive-strength gap in the AND and XOR gate families of the SCL 180nm library. By using STMicroelectronics 65nm delay trends as a baseline, this work proposes the addition of X1.5 drive variant to bridge the performance gap found in the low-drive region.
